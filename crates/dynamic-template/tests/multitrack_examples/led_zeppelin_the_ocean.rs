...
fn led_zeppelin_the_ocean() -> Result<()> {
    ...
    let expected = TrackStructureBuilder::new()
        ...
        .track("Snare").item("02.SNR_01.wav")
        .folder("OH")
        .track("OH 1").item("03. OHL_01.wav")
        .track("OH 2").item("04. OHR_01.wav")
        .end()
        .folder("Rooms")
        .track("L").item("05. Room_01 L.wav")
        .track("R").item("06. Room_01 R.wav")
        .end()
        .end()
        .folder("Bass")
        .track("Bass").item("07. Bass DI_01.wav")
        .track("Amp").item("08. Bass ReAmp_01.wav")
        .end()
        .folder("Guitars")
        .track("L Main Riff.A1").item("09. Gtr L Main Riff.A1_01.wav")
        .track("L Main Riff.A2").item("10. Gtr L Main Riff.A2_01.wav")
        .track("Gtr_L.A1").item("11. Gtr_L.A1_01.wav")
        .track("Gtr_L.A2").item("12. Gtr_L.A2_01.wav")
        .track("Gtr_R.A1").item("13. Gtr_R.A1_01.wav")
        .track("Gtr_R.A2").item("14. Gtr_R.A2_01.wav")
        .end()
        .folder("Vocals")
        .folder("Lead")
        .folder("Outro")
        .track("Outro 1").item("23. Outro Vocal 1_01.wav")
        .track("Outro 2").item("24. Outro Vocal 2_01.wav")
        .track("Outro 3").item("25. Outro Vocal 3_01.wav")
        .track("Outro 4").item("26. Outro Vocal 4_01.wav")
        .track("Outro 5").item("27. Outro Vocal 5_01.wav")
        .end()
        .track("Lead").item("19. lead_Vox_01.wav")
        .track("Lead 1").item("20. LA LA Voc 1_01.wav")
        .track("Lead 2").item("21. LA LA Voc 2_01.wav")
        .end()
        .track("BGVs").item("22. Vocal Adlib_01.wav")
        .end()
        .folder("Unsorted")
        .track("Lead_1.A1").item("15. lead_1.A1_01.wav")
        .track("Lead_1.A2").item("16. lead_1.A2_01.wav")
        .track("Lead_2.A1").item("17. lead_2.A1_01.wav")
        .track("Lead_2.A2").item("18. lead_2.A2_01.wav")
        .track("The Ocean").item("28. The Ocean_01.wav")
        .end()
        .build();
