...
fn cyndi_lauper_time_after_time() -> Result<()> {
    ...
    let expected = TrackStructureBuilder::new()
        .folder("Drums")
        .track("Kick").item("08.Kick.TimeAfterTime.126bpm_01.wav")
        .track("Snare").item("09.Snare.TimeAfterTime.126bpm_01.wav")
        .folder("OH")
        .track("Hi Hat").item("11.Overhead Hat.TimeAfterTime.126bpm_01.wav")
        .track("Ride").item("12.Overhead Ride.TimeAfterTime.126bpm_01.wav")
        .end()
        .folder("Rooms")
        .track("L").item("13.Room.Left.TimeAfterTime.126bpm_01.wav")
        .track("R").item("14.Room.Right.TimeAfterTime.126bpm_01.wav")
        .track("Mono").item("10.Kit.Mono.Room.TimeAfterTime.126bpm_01.wav")
        .end()
        .end()
        .folder("Percussion")
        .track("Shaker 1").item("15.SHAKER.Left_01.wav")
        .track("Shaker 2").item("16.SHAKER.Right_01.wav")
        .end()
        .folder("Bass")
        .track("Warren Amp").item("06.BASS AMP.Warren.TimeAfterTime.126bpm_01.wav")
        .track("Warren DI").item("07.BASS DI.Warren.TimeAfterTime.126bpm_01.wav")
        .end()
        .folder("Guitars")
        .folder("Electric")
        .track("Left").item("04.Electric.Gtr.Left.Warren.TimeAfterTime.126bpm_01.wav")
        .track("Right").item("05.Electric.Gtr.Right.Warren.TimeAfterTime.126bpm_01.wav")
        .end()
        .track("Acoustic").item("03.Acoustic Guitar.Nick.TimeAfterTime.126bpm_01.wav")
        .end()
        .folder("Vocals")
        .track("Lead").item("01.LV BECCA.TimeAfterTime.126bpm_01.wav")
        .track("BGVs").item("02.BV LUCA.TimeAfterTime.126bpm_01.wav")
        .end()
        .track("Guide").item("17.Click.Print_01.wav")
        .track("Reference").item("18.Time After Time Presonus HD8 Mix_01.wav")
        .build();
