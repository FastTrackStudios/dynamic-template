...
fn iron_maiden_the_trooper() -> Result<()> {
    ...
    let expected = TrackStructureBuilder::new()
        .folder("Drums")
        .track("Kick").item("08-Kick-TheTrooper.wav")
        .track("Snare").item("09-Snare-TheTrooper.wav")
        .track("OH").item("10-OH-TheTrooper.wav")
        .end()
        .folder("Bass")
        .track("Bass").item("12-Bass DI-TheTrooper.wav")
        .track("Amp").item("13-Bass Amp-TheTrooper.wav")
        .end()
        .folder("Guitars")
        .track("Rhy L").item("15-Rhy Gtr L-TheTrooper.wav")
        .track("Rhy R").item("16-Rhy Gtr R-TheTrooper.wav")
        .end()
        .folder("Vocals")
        .track("Vocals 1").item("21-Vocal 1-TheTrooper.wav")
        .track("Vocals 2").item("22-Vocal 2-TheTrooper.wav")
        .track("Vocals 3").item("23-Vocal 3-TheTrooper.wav")
        .end()
        .track("Reference").item("Trooper-mix1.wav")
        .folder("Unsorted")
        .track("Solo 1").item("17-Solo 1-TheTrooper.wav")
        .track("Solo 2").item("18-Solo 2-TheTrooper.wav")
        .track("Solo 3").item("19-Solo 3-TheTrooper.wav")
        .end()
        .build();
