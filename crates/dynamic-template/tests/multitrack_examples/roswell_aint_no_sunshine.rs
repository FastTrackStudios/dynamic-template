...
fn roswell_aint_no_sunshine() -> Result<()> {
    ...
    let expected = TrackStructureBuilder::new()
        ...
        .folder("Toms")
        .track("Tom 3").item("Tom  3.wav")
        .track("Tom 4").item("Tom  4.wav")
        .end()
        .folder("Cymbals")
        .track("OH").item("Overhead.wav")
        .track("Hi Hat").item("HiHat.wav")
        .end()
        .end()
        .folder("Percussion")
        .folder("Djembe")
        .track("Bottom").item("01.Djembe Bottom 47X_01.wav")
        .track("Top 1").item("02.Djembe Top 67X_01.wav")
        .track("Top 2").item("Djembe Top Quantized.wav")
        .end()
        .track("Sidestick").item("Sidestick.wav")
        .end()
        .folder("Bass")
        .track("Bass").item("03.Bass DI.01_02.wav")
        .track("Amp").item("04.Bass Amp 47X_01.wav")
        .end()
        .folder("Guitars")
        .track("Acoustic").item("10.Acoustic 47X_01.wav")
        .track("Guitars").item("05.Gtr DI.01_02.wav")
        .track("Amp").item("06.Gtr Amp.67X_01.wav")
        .track("Warren Amp").item("07.Gtr Warren Amp.01_02.wav")
        .track("Solo DI").item("08.Gtr Solo DI.01_02.wav")
        .track("Solo Amp").item("09.Gtr Solo Amp.67X_01.wav")
        .end()
        .track("Vocals").item("11.Vocal.47X_01.wav")
        .folder("Orchestra")
        .track("Strings 1").item("STRINGS HIGH.wav")
        .track("Strings 2").item("STRINGS MAIN.wav")
        .end()
        .track("Reference").item("12.Ain't No Sunshine Mix_Roswell Mini K47x Mini K67x_02.wav")
        .build();
